...
window.CatalogDicts = {
    crops: ['Картофель', 'Лук', 'Свекла', 'Морковь', 'Капуста', 'Свекла столовая', 'Помидоры', 'Спец. овощи', 'Тыква', 'Огурцы', 'Батат'],
    ...
    pitches: [14, 15, 16, 20, 24, 28, 32, 35, 36, 40, 42, 45, 50],
    beltTypes: [
    ...
    beltWidths: ['20', '30', '40', '45', '50', '55', '60', '65', '70', '75', '60-75'],
    beltThicknesses: ['12', '17', '20', '25', '28-30'],
    beltHoleDistances: ['20', '23', '28', '30', '32'],
    ...
    connectionTypes: [
        ...
        { id: 'vulcanization', name: 'К вулканизации', img: '36.jpg' },
        { id: 'open', name: 'Открытый', img: '37.jpg' },
        { id: 'screws', name: 'На винтах', img: '38.jpg' }
    ]
};
