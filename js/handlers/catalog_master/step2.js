            ...
            <div class="step-panel animate-fade-in">
                ...
                <div style="display:grid; grid-template-columns: 1.5fr 1fr; gap:20px; background:rgba(255,255,255,0.01); padding:25px; border-radius:20px; border:1px solid rgba(255,255,255,0.1); align-items:center;">
                    <div style="display:flex; flex-direction:column; gap:12px;">
                        <div style="display:flex; justify-content:space-between; align-items:center;"><label class="text-xs neutral font-bold" style="text-transform:uppercase;">ДЛИНА В КОЛЬЦО (ММ):</label><input type="number" id="m-len-2" value="${s.length}" oninput="window.CatalogStep2.sync('len')" class="step2-input"></div>
